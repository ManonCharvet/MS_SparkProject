...
object Preprocessor_corr {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("train.csv")
      //.csv("/Users/maxime/TP_parisTech_2017_2018/data/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/Manon/Documents/Cours/MS/Spark/TP_ParisTech_2017_2018_starter/prepared_trainingset")
